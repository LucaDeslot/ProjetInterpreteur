...
char const * Symbole::FICHIER_MOTS_CLES = "motsCles.txt";
...
bool Symbole::operator==(string const & ch) const {
    return this->m_chaine == ch
            ...
            || (this->m_categorie == FINDEFICHIER
                    && (ch == "<FINDEFICHIER>" || ch == "<findefichier>"));
}

bool Symbole::isMotCle(string const & s) const {
...
ostream & operator<<(ostream & cout, Symbole const & symbole) {
    cout << "Symbole de type ";
    if (symbole.m_categorie == Symbole::MOTCLE)
        cout << "<MOTCLE>      ";
    else if (symbole.m_categorie == Symbole::VARIABLE)
        cout << "<VARIABLE>    ";
    else if (symbole.m_categorie == Symbole::ENTIER)
        cout << "<ENTIER>      ";
    else if (symbole.m_categorie == Symbole::CHAINE)
        cout << "<CHAINE>      ";
    else if (symbole.m_categorie == Symbole::INDEFINI)
        cout << "<INDEFINI>    ";
    else if (symbole.m_categorie == Symbole::FINDEFICHIER)
        cout << "<FINDEFICHIER>";
